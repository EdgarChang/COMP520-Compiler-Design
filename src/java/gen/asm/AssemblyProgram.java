...
public class AssemblyProgram {
    ...
    public static class Section {
        ...
        public void emit(String opcode, Register dst, int imm) {
            assert this.type == Type.TEXT;
            items.add(new AssemblyItem.Instruction.LiInstruction(opcode, dst, imm));
        }
        ...
        public void emitLoadCLabel(Register dst, AssemblyItem.Label label) {
        	assert this.type == Type.TEXT;
        	items.add(new AssemblyItem.Instruction.LoadCLabelInstruction(dst, label));
        }
        ...
        public void emitStoreLabel(Register dst, AssemblyItem.Label label) {
        	assert this.type == Type.TEXT;
        	items.add(new AssemblyItem.Instruction.StoreLabelInstruction(dst, label));
        }
